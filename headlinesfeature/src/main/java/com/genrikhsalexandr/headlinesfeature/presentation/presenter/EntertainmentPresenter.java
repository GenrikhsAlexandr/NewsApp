...
@InjectViewState
public class EntertainmentPresenter extends MvpPresenter<HeadlinesView> {
    ...
    private void loadFirstPage() {
        ...
        isLoading = true;
        disposable = interactor.getArticlesList(currentPage, Category.ENTERTAINMENT)
